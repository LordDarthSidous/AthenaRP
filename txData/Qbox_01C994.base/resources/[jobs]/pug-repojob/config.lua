----------
Config.VehilceKeysGivenToPlayerEvent = "vehiclekeys:client:SetOwner" -- Event used to give player keys to vehicle (IF YOU ARE USING QS-VEHICLEKEYS DO NOT WORRY ABOUT THIS)
Config.Currency = "bank" -- Currency used for the truck deposit and pay at the end.
----------
Config.AutomaticallHookVehicle = false -- Automatically hook the vehicle to the tow truck when it gets close enough while being pulled by the rope
Config.SetVehiclesLocked = true -- Lock the doors of the vehicle being repoed.
Config.WarpPlayerToVehicle = false -- Warp the player to the flatbed truck when it spawns.
...
Config.AllowRepoJobToImpoundPlayerVehicles = true -- Make this true if you want players with the repojob to be able to impound player vehicles
----------
----------
...
Config.BlipColor = 27 -- Repo job blip color
Config.BlipScale = 0.7 -- Repo job blip size
Config.BlipLabel = "Job: Vehicle Repo" -- Repo job blip text
----------
Config.JobReequired = false -- Make this true or false for if the player needs the Config.JobName job role to do this job.
Config.JobName = "repo" -- This is the job name required only if Config.JobReequired is true
Config.PricePerImpoundedPlayerVehicle = 1000 -- Price the player pays to get there vehicle out of impound. 
----------
Config.RepoPedModel = "s_m_y_airworker" -- The model of the ped that stand there for you to bein the job.
----------
if GetResourceState("cfx-gabz-impound") == 'started' then
    Config.FlatBedSpawns = { -- FLAT BED SPAWN LOCATIONS IF YOU HAVE THE GABZ IMPOUND MLO
        vector4(-183.46, -1175.72, 23.14, 199.92),
        vector4(-186.75, -1176.23, 23.13, 200.45),
        vector4(-190.17, -1176.3, 23.13, 201.3), 
        vector4(-193.81, -1175.67, 23.13, 200.91),
        vector4(-197.04, -1176.4, 23.13, 200.95),
    }
    Config.RepoPedLocation = vector4(-200.09, -1167.29, 22.16, 92.16) -- BEGIN JOB PED IF YOU HAVE THE GABZ IMPOUND MLO
    Config.CraftingBenchLocation = vector4(-200.3, -1164.5, 23.16, 89.75) -- CRAFTING BENCH LOCATION IF YOU HAVE THE GABZ IMPOUND MLO
else
    Config.FlatBedSpawns = { -- THIS IS IF YOU DO NOT HAVE THE GABZ IMPOUND MLO
        vector4(-227.76, -1165.07, 23.04, 178.54), 
        vector4(-231.3, -1164.75, 23.02, 179.86),
        vector4(-234.93, -1164.98, 23.03, 179.71),
        vector4(-239.32, -1164.82, 23.09, 180.33),
    }
    Config.RepoPedLocation = vector4(-218.64, -1168.61, 22.02, 93.89) -- THIS IS IF YOU DO NOT HAVE THE GABZ IMPOUND MLO
    Config.CraftingBenchLocation = vector4(-218.5, -1171.53, 23.02, 88.51) -- THIS IS IF YOU DO NOT HAVE THE GABZ IMPOUND MLO
end
----------
----------
Config.RareItemDropChance = 1 -- % chance that the player recieves a Config.RareItemDropItem when finishing a repo job
Config.RareItemDropItem = "security_card_01" -- Rare item that the player recieves a when finishing a repo job (Config.RareItemDropChance is the % chance they will get this item)
----------
----------
...
----------
Config.AngryPed1Chance = 15 -- % chance that one angry ped will spawn at the repo vehicle (15/100 % chance by default)
Config.AngryPed2Chance = 45 -- % chance that a second angry ped will spawn at the repo vehicle (Config.AngryPed2Chance cant have a chance of spawning if Config.AngryPed1Chance doesnt spawn) (45/100 % chance by default)
----------
...
Config.LangT = {
    ...
    ["RepoPlayerVehicleHeader"] = "Repo players vehicle",
    ["ImpoundPlayerVehicle"] = "Impound Vehicle",
    ["ImpoundPlayerVehicleDescription"] = "Impound charge: "..Config.PricePerImpoundedPlayerVehicle,
    ["OnlyImpoundPlayerVehicles"] = "You can only impound player owned vehicles",
    -- DrawText
    ["ReturnHook"] = "[E] Return Hook",
    ["GrabHook"] = "[E] Grab Hook",
    ["DropOffVehicle"] = "[E] Drop off vehicle",
    ["ImpoundPlayersVehicle"] = "[E] Impound Player Vehicle",
    -- Email
    ...
    ["NotRepoEmployee"] = "You are not a " .. Config.JobName .. " employee.",
...
Config.DropoffPedLocation = {
    ...
    [3] = {
        Ped = vector4(-238.2, -1186.39, 23.03, 359.63),
        Truck = vector4(-242.6, -1179.14, 23.04, 136.83),
    },
}
----------
----------
Config.ImpoundPlayerVehicleZone = {
    ["1"] = {
        ['Zone'] = {
            ['Shape'] = {
                vector2(1625.78, 3802.56),
                vector2(1622.41, 3805.44),
                vector2(1634.84, 3814.83),
                vector2(1637.68, 3810.76),
            },
            ['minZ'] = 21.044055938721,  -- min height of the impound player vehicle zone
            ['maxZ'] = 45.044055938721,  -- max height of the impound player vehicle zone

            ['location'] = vector4(1629.41, 3807.61, 34.94, 125.07), -- Camera position for when a player first does the repo job
        },
    },
}
----------
...
Config.CraftingParts = {
    ["radio"] = {
        rep = 720,
        Parts = {
            -- ["engine_block"] = { Amount = 1 },
            ["metalscrap"] = { Amount = 120 },
            ["steel"] = { Amount = 80 },
            ["aluminum"] = { Amount = 40 },
            ["rubber"] = { Amount = 55 },
            ["electronic_component"] = { Amount = 45 }, -- sensors / ECU components
        }
    },
    ...
    --         -- ["engine_block"] = { Amount = 1 },
    --         ["gear"] = { Amount = 8 },
    --         ["metalscrap"] = { Amount = 160 },
    --         ["steel"] = { Amount = 110 },
    --         ["aluminum"] = { Amount = 60 },
    --         ["rubber"] = { Amount = 85 },
    --         ["electronic_component"] = { Amount = 55 },
    --     }
    -- },
    ...
    --         -- ["engine_block"] = { Amount = 1 },
    --         ["gear"] = { Amount = 95 },
    --         ["metalscrap"] = { Amount = 220 },
    --         ["steel"] = { Amount = 150 },
    --         ["aluminum"] = { Amount = 90 },
    --         ["rubber"] = { Amount = 130 },
    --         ["electronic_component"] = { Amount = 75 },
    --     }
    -- },
    ...
    --     Parts = {
    --         -- ["turbine"] = { Amount = 1 },
    --         ["metalscrap"] = { Amount = 280 },
    --         ["steel"] = { Amount = 170 },
    --         ["aluminum"] = { Amount = 125 },
    --         ["rubber"] = { Amount = 170 }, -- seals
    --         ["electronic_component"] = { Amount = 116 }, -- boost control / sensors
    --     }
    -- },
